...
class List(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        sorted = Human.objects.filter(birth__year__gte=1950).order_by('birth')
        sorted_salary = Human.objects.filter(salary__gte=100, salary__lte=10000).order_by('-salary')
